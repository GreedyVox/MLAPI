...
//     [MenuItem ("Tools/GreedyVox/NetCode/Character Inspector")]
//     private static NetCodeCharacterInspector Init () {
//         return EditorWindow.GetWindowWithRect<NetCodeCharacterInspector> (
...
//         }
//         ComponentUtility.TryAddComponent<NetCodeCharacterTransformMonitor> (obj);
//         ComponentUtility.TryAddComponent<NetCodeAnimatorMonitor> (obj);
//         ComponentUtility.TryAddComponent<NetCodeLookSource> (obj);
...
//             ComponentUtility.TryAddComponent<NetCodeDestructibleMonitor> (obj);
//         }
...
//             var remotePlayerPerspectiveMonitor = ComponentUtility.TryAddGetComponent<NetCodeRemotePlayerPerspectiveMonitor> (obj);
...
//         if (ComponentUtility.TryAddComponent<NetCodeRuntimePickups> (obj)) {

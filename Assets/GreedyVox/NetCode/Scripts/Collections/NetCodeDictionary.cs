...
// namespace GreedVox.NetCode.Collections {
//     public class NetCodeDictionary<TK, TV> : NetworkVariableBase, IDictionary<TK, TV>, IEnumerable<KeyValuePair<TK, TV>>
...
//             public delegate void OnDictionaryChangedDelegate (NetCodeDictionaryEvent<TK, TV> e);
//             /// <summary>
...
//             private NativeList<NetCodeDictionaryEvent<TK, TV>> m_DirtyEvents =
//                 new NativeList<NetCodeDictionaryEvent<TK, TV>> (64, Allocator.Persistent);
//             /// <inheritdoc />
...
//                 set {
//                     m_HashMap[key] = value;
//                     HandleAddListEvent (new NetCodeDictionaryEvent<TK, TV> () {
//                         Type = NetCodeDictionaryEvent<TK, TV>.EventType.Value, Key = key, Value = value
//                     });
//                 }
//             }
//             /// <summary>
//             /// Creates a NetCodeDictionary with the default value and settings
//             /// </summary>
//             public NetCodeDictionary () { }
//             public NetCodeDictionary (int capacity) {
//                 m_HashMap.Capacity = capacity;
//                 m_DirtyEvents.Capacity = capacity;
//             }
//             /// <summary>
//             /// Creates a NetCodeDictionary with a custom value and the default settings
//             /// </summary>
//             /// <param name="values">The initial value to use for the NetCodeDictionary</param>
//             public NetCodeDictionary (IEnumerator<KeyValue<TK, TV>> items) {
//                 while (items.MoveNext ()) { m_HashMap.Add (items.Current.Key, items.Current.Value); }
//             }
//             /// <summary>
//             /// Creates a NetCodeDictionary with the default value and custom settings
//             /// </summary>
//             /// <param name="readPerm">The read permission to use for the NetCodeDictionary</param>
//             /// <param name="values">The initial value to use for the NetCodeDictionary</param>
//             public NetCodeDictionary (NetworkVariableReadPermission readPerm, IEnumerator<KeyValue<TK, TV>> items) : base (readPerm) {
//                 while (items.MoveNext ()) { m_HashMap.Add (items.Current.Key, items.Current.Value); }
//             }
//             /// <inheritdoc />
...
//                 reader.ReadValueSafe (out ushort count);
//                 for (int i = 0; i < count; i++) {
//                     reader.ReadValueSafe (out NetCodeDictionaryEvent<TK, TV>.EventType type);
//                     switch (type) {
//                         case NetCodeDictionaryEvent<TK, TV>.EventType.Add:
//                             {
//                                 reader.ReadValueSafe (out TK key);
//                                 reader.ReadValueSafe (out TV value);
//                                 m_HashMap.Add (key, value);
//                                 if (OnDictionaryChanged != null) {
//                                     OnDictionaryChanged (new NetCodeDictionaryEvent<TK, TV> {
//                                         Type = type,
//                                         Key = key,
//                                         Value = value
//                                     });
//                                 }
//                                 if (dirty) {
//                                     m_DirtyEvents.Add (new NetCodeDictionaryEvent<TK, TV> () {
//                                         Type = type, Key = key, Value = value
//                                     });
//                                 }
//                             }
//                             break;
//                         case NetCodeDictionaryEvent<TK, TV>.EventType.Remove:
//                             {
//                                 reader.ReadValueSafe (out TK key);
...
//                             }
//                             break;
//                         case NetCodeDictionaryEvent<TK, TV>.EventType.Value:
//                             {
//                                 reader.ReadValueSafe (out TK key);
//                                 reader.ReadValueSafe (out TV value);
//                                 m_HashMap[key] = value;
...
//                             }
//                             break;
//                         case NetCodeDictionaryEvent<TK, TV>.EventType.Clear:
//                             {
//                                 m_HashMap.Clear ();
//                                 if (OnDictionaryChanged != null) {
//                                     OnDictionaryChanged (new NetCodeDictionaryEvent<TK, TV> { Type = type });
//                                 }
//                                 if (dirty) {
//                                     m_DirtyEvents.Add (new NetCodeDictionaryEvent<TK, TV> () { Type = type });
//                                 }
//                             }
//                             break;
//                         case NetCodeDictionaryEvent<TK, TV>.EventType.Full:
//                             {
//                                 ReadField (reader);
//                                 ResetDirty ();
//                             }
...
//                     writer.WriteValueSafe (NetCodeDictionaryEvent<TK, TV>.EventType.Full);
//                     WriteField (writer);
//                 } else {
...
//                 m_HashMap.Clear ();
//                 HandleAddListEvent (new NetCodeDictionaryEvent<TK, TV> () {
//                     Type = NetCodeDictionaryEvent<TK, TV>.EventType.Clear
//                 });
//             }
//             /// <inheritdoc />
...
//                 m_HashMap.Add (key, value);
//                 HandleAddListEvent (new NetCodeDictionaryEvent<TK, TV> () {
//                     Type = NetCodeDictionaryEvent<TK, TV>.EventType.Add, Key = key, Value = value,
//                 });
//             }
//             /// <inheritdoc />
...
//                 HandleAddListEvent (new NetCodeDictionaryEvent<TK, TV> () {
//                     Type = NetCodeDictionaryEvent<TK, TV>.EventType.Add, Key = item.Key, Value = item.Value,
//                 });
//             }
//             /// <inheritdoc />
...
//                     HandleAddListEvent (new NetCodeDictionaryEvent<TK, TV> () {
//                         Type = NetCodeDictionaryEvent<TK, TV>.EventType.Remove, Key = key
//                     });
//                     return true;
//                 }
//                 return false;
...
//                     HandleAddListEvent (new NetCodeDictionaryEvent<TK, TV> () {
//                         Type = NetCodeDictionaryEvent<TK, TV>.EventType.Remove, Key = item.Key
//                     });
//                     return true;
//                 }
//                 return false;
...
//             }
//             private void HandleAddListEvent (NetCodeDictionaryEvent<TK, TV> e) {
//                 m_DirtyEvents.Add (e);
//                 OnDictionaryChanged?.Invoke (e);
//             }
//         }
//     /// <summary>
//     /// Struct containing event information about changes to a NetCodeDictionary.
//     /// </summary>
//     /// <typeparam name="T">The type for the list that the event is about</typeparam>
//     public struct NetCodeDictionaryEvent<TK, TV> {
//         /// <summary>

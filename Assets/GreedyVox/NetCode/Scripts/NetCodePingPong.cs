...
namespace GreedyVox.NetCode
{
    public class NetCodePingPong : NetworkBehaviour
    {
        ...
        [Rpc(SendTo.Server)]
        public void PingRpc(float ping, RpcParams rpcParams = default) =>
        PongRpc(ping, "PONG!", RpcTarget.Single(rpcParams.Receive.SenderClientId, RpcTargetUse.Temp));
        ...
        void PongRpc(float ping, string message, RpcParams rpcParams) =>

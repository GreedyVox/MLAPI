...
//         // private Dictionary<ulong, NetCodeClient> m_NetworkObjects;
...
//             var colliderID = 0UL;
//             if (collider != null) {
//                 colliderID = NetCodeUtility.GetID (collider.gameObject, out hitSlotID);
//             }
//             if (IsServer) {
...
//                 }
//             }
//             var collider = NetCodeUtility.RetrieveGameObject (m_GamingObject, (ulong) hitID, hitSlotID);

...
//     using GreedVox.NetCode.Collections;
...
//         private NetCodeDictionary<ulong, NetworkObjectReference> m_Players;
...
//             m_Players = new NetCodeDictionary<ulong, NetworkObjectReference> (128);
//         }
//         /// <summary>
//         /// Registering events.
//         /// </summary>
...
//                 if (NetCodeDictionaryEvent<ulong, NetworkObjectReference>.EventType.Add == e.Type) {
//                     m_ActiveCharacterStates[e.Key] = new HashSet<string> ();
//                 } else if (NetCodeDictionaryEvent<ulong, NetworkObjectReference>.EventType.Remove == e.Type) {
